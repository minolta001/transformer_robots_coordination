...
```bash
# With SBD
python3.6 -m rl.main --env husky-forward-v0 --gpu 0 --prefix husky-1-backward-n --env_args husky-1/direction-backward --seed 1 --max_global_step 1000000
python3.6 -m rl.main --env husky-forward-v0 --gpu 0 --prefix husky-1-forward-n --env_args husky-1/direction-forward --seed 1 --max_global_step 1000000

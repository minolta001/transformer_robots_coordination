...
python3 -m rl.main --env husky-push-v0 --gpu 0 --prefix collab_push-NonHierarchical-NonSpatial-seed1 --seed 1 --meta hard --meta_update_target LL --subdiv husky_1,box_1,husky_2,box_2,relative_info-husky_1,husky_2 --max_meta_len 5 --max_global_step 2000000

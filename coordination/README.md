...
python3.6 -m rl.main --env husky-forward-v0 --gpu 0 --prefix h-2-align --env_args husky-2/skill-align --z_dim 2 --seed 1 --max_global_step 2000000
python3.6 -m rl.main --env husky-forward-v0 --gpu 0 --prefix h-2-push --env_args husky-2/skill-push --z_dim 2 --seed 1 --max_global_step 2000000

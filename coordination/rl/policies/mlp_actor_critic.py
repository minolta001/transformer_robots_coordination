...
class MlpActor(Actor):
    def __init__(self, config, ob_space, ac_space, tanh_policy):
        ...
        self.fc = MLP(config, input_dim, config.rl_hid_size, [config.rl_hid_size] * 1)  # was only 1
    ...
    def forward(self, ob):
        ...
        # MLP output will be passed to activation function
...
class MlpCritic(Critic):
    def __init__(self, config, ob_space, ac_space=None):
        ...
        self.fc = MLP(config, input_dim, 1, [config.rl_hid_size] * 2)   # was 2
